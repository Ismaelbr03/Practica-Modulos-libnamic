...
class RegistrationService(BaseService):
    ...
    # Calcula el aforo sobrescribiendo la creacion base
    def create(self, data: dict) -> dict:
        ...
        # Cuenta los confirmados del evento
    ...
    def confirm(self, id: int, note: str | None = None) -> dict:
        ...
        if not reg:
            raise HTTPException(400, "Inscripción no encontrada")
